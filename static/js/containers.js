...
/*
 * Script originates from http://matchingnotes.com/using-google-map-tiles-with-leaflet
 * (https://gist.github.com/crofty/2197042)
 * Updated it to be AMD compatible.
 */

define('leaflet-google',[
  'leaflet',
  'gmaps'
], function (L, gmaps) {
  ...
  return L.Class.extend({
    ...
    initialize:function (type, options) {
      ...
      this._type = gmaps.MapTypeId[type || 'SATELLITE'];
    },
    ...
    _initMapObject:function () {
      this._google_center = new gmaps.LatLng(0, 0);
      var map = new gmaps.Map(this._container, {
      ...
      var _this = this;
      this._reposition = gmaps.event.addListenerOnce(map, "center_changed",
        function () {
          _this.onReposition();
        });
    ...
    _update:function () {
      ...
      var google_bounds = new gmaps.LatLngBounds(
        new gmaps.LatLng(sw.lat, sw.lng),
        new gmaps.LatLng(ne.lat, ne.lng)
      );
      var center = this._map.getCenter();
      var _center = new gmaps.LatLng(center.lat, center.lng);
    ...
    _resize:function () {
      ...
      this._container.style.width = size.x + 'px';
      this._container.style.height = size.y + 'px';
      gmaps.event.trigger(this._google, "resize");
    },
...
define('google-analytics-amd',['require'],function (require) {
...
define('moment-timezone-data',["moment-timezone"], function (moment) {
  moment.tz.add({
    "zones": {
      "Europe/Prague": [
...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        define('moment-lang-cs',['moment'], factory); // AMD
